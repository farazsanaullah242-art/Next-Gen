...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://erpnext.org">Next GEN</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """Next GEN can only be installed on a fresh site where the setup wizard is not completed.
...
def add_app_name():
	frappe.db.set_value("System Settings", None, "app_name", "Next GEN")
